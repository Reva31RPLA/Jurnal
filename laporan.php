...
<body>
    ...
    <h1 class="mb-3">Halaman Kirim Laporan Harian</h1>
    <form>
        ...
        <div class="form-group">
            ...
            <textarea class="form-control" id="deskripsi" rows="5" placeholder="Tulis Deskripsi Kegiatan Anda"></textarea>
        </div>
        <button type="submit" class="btn btn-light">Kirim Laporan</button>
    </form>
    </div>
    </div>
